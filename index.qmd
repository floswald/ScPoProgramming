...
| 8            | [`R` and `python` generics](06-concepts.qmd) | Florian Oswald|
| 9            | [`R {data.table}`](https://raw.githack.com/floswald/lectures/master/05-datatable/05-datatable.html) | [Grant McDermott](https://grantmcdermott.com/)  + Florian Oswald|
| 10            | [Building `R` packages](09-R-packages.qmd) |  Florian Oswald|
| 11            | [Spatial Data with `R`](10-spatial-R.qmd) |  Florian Oswald|
| 12            | [`julia` intro 1](https://floswald.github.io/julia-bootcamp/01-variables.html) |  Florian Oswald|
| 13            | [`julia` intro 2](https://floswald.github.io/julia-bootcamp/02-functions.html) |  Florian Oswald|
| 14            | [Quick Intro to NLP with R](11-NLP-R.qmd) |  Florian Oswald|
